                    ...
                    return (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="opacity-100 md:opacity-0 md:group-hover:opacity-100 p-1.5 text-[#9CA3AF] hover:text-rose-600 active:text-rose-600 hover:bg-rose-50 active:bg-rose-100 rounded-lg transition-all cursor-pointer shrink-0 touch-manipulation"
